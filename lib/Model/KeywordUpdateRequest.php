...
/**
 * KeywordUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Boostapp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeywordUpdateRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['keyword_ids'] === null) {
            $invalidProperties[] = "'keyword_ids' can't be null";
        }
     ...
     * Sets identifier
     *
     * @param string $identifier Customer identity, leave empty to take action with the application that attached in your dealer account (Cannot be NULL)
     *
     * @return $this
     */
     ...
     * Sets keyword_ids
     *
     * @param int[] $keyword_ids Keyword identity numbers (Max 10-item can be defined)
     *
     * @return $this
     */
