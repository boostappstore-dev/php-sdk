...
/**
 * ApplicationProductsRequest Class Doc Comment
 *
 * @category Class
 * @description Useable product list request for the application
 * @package  Boostapp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationProductsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationProductsRequest';
     ...
     * Sets identifier
     *
     * @param string $identifier Customer identity, leave empty for applications that linked with your dealer account (Cannot be NULL)
     *
     * @return $this
     */
