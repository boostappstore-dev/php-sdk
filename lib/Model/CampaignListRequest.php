...
/**
 * CampaignListRequest Class Doc Comment
 *
 * @category Class
 * @package  Boostapp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignListRequest';
     ...
     * Sets identifier
     *
     * @param string $identifier Customer identity, leave empty for listing campaigns that linked with your dealer account (Cannot be NULL)
     *
     * @return $this
     */
